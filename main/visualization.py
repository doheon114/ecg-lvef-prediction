...
def plot_segmented_ecg(instance_ecg, slice_width, PATH):
    """
...
def plot_perturbed_ecg(original_ecg, perturbed_ecg, perturbation, num_slices, PATH, title='ECG Signal with Perturbation'):
    """
